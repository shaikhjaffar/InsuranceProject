...
function Policy() {
  ...
  return (
    <>
    <div className='card-of-policy' id='privacy'>
          <div className='text-heading-of-policy'> PRIVACY POLICY </div>
        <div className='content-ka-card-of-policy'> 
      
      <div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> INTRODUCTION  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> PERSONAL INFORMATION COLLECTED  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> GOVERNING STATUTE  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> COOKIES  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> DISCLOSURES  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>DATA RETENTION</div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>  SECURITY </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>  ACCESSING AND MODIFYING PERSONAL INFORMATION </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>  ANCILLIARY SERVICES </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> COMMUNICATIONS FROM THE PLATFORM  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>  INDEMNIFICATION </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> LIMITATIONS OF LIABILITY  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> GOVERNING LAWS AND DUTIES  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'> FORCE MAJEURE:  </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>  CHANGES TO THIS POLICY: </div>
<div className='content-text-of-policy'>
...
<div className='Bold-text-heading'>  CONTACT US: </div>
<div className='content-text-of-policy'>
