...
The revolution to extra-ordinary from ordinary can only happen by the hard –work of my teammates and my ideas.
 ...
 <div className='detail-about'>
    <div className='about-container not-zoom'>
      <img className='about-image' src={Drdk} alt="Advisory-Board-1-Click-Capital">
      </img>
...
.</p>
    ...
    <div className='about-container not-zoom'>
    <img className='about-image' src={Prerak} alt="Advisory-Board-1-Click-Capital">
      </img>
    ...
    <div className='about-container not-zoom'>
      <img className='about-image' src={Ameet} alt="Advisory-Board-1-Click-Capital"/>
